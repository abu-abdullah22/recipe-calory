const Banner = () => {
    return (
        <div className="mt-12 bg-[url('../src/assets/images/banner.png')] bg-no-repeat md:h-[680px] w-[90vw] p-3 md:p-0 bg-cover bg-center container mx-auto rounded-[24px] flex items-center justify-center flex-col space-y-5">
